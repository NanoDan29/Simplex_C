...
public class MetodoSimplex {
    ...
    public MetodoSimplex(List<String> listVariables, double m[][], List<String> listVariablesDeCambio) {
    ...
    public double[][] operar(double m[][], boolean t) {
        ...
        int c = colum_min(m);
        if (c == -1) { //si el metodo colum_min retorna -1, es porque no encuentra el elemento mas negativo 
            c = columnaFaltante();
            if (c == -1) {
                return m;
            }
